...
<body>
	<div id="main" align="center" class="container-fluid">
		<div id="picture"><img id="picture1" src="images/indexpic.png" alt="Grizzly" ></div>
		
		<div id="form" >
			<form name="myForm" action="/grizzly-store-vendor-web/VerifyVendorController" novalidate>
